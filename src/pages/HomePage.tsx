import { HeartOutlined, HomeOutlined,  StarFilled, SearchOutlined,ShoppingCartOutlined,TagOutlined,UserOutlined} from "@ant-design/icons";
    ...
    <div className="mt-[60px]">
      ...
      <div className="px-4">
        ...
        <div className="mt-6">
          ...
          <div className="flex item-center gap-4 mt-3">
            <div className="h-[238px] w-[141px] border border-[#EBF0FF] rounded-lg p-4 ">
              <img src="https://bom.so/OUpZ1C" alt="Mo ta" className="w-[109px] h-[109px] rounded-lg  "/>
              <div className=" flex flex-col mt-2 gap-2 ">
                <h6 className="text-xs font-bold text-[#223263] w-[109px] h-[36px] ">FS - Nike Air Max 270 React...</h6>
            ...
            <div className="h-[238px] w-[141px] border border-[#EBF0FF] rounded-lg p-4 ">
              <img src="https://bom.so/StoIIq" alt="Mo ta" className="w-[109px] h-[109px] rounded-lg  "/>
              <div className=" flex flex-col mt-2 gap-2 ">
                <h6 className="text-xs font-bold text-[#223263] w-[109px] h-[36px] ">FS - QUILTED MAXI CROS...</h6>
                <p className="text-xs font-bold text-[#40BFFF] w-[52px] h-[22px] ">$299,43</p>
                <div className="flex item-center">
                  <p className="font-normal text-[10px] text-[#9098B1] line-through mr-[8px] w-[42px] h-[15px]">$534,33 </p>
                  <p className="font-bold text-[10px] text-[#FB7181] w-[59px] h-[15px]">24% Off </p>
            ...
            {/* <div className="h-[238px] w-[141px] border border-[#EBF0FF] rounded-lg p-4 ">
                <img src="https://bom.so/m1P6z0" alt="Mo ta" className="w-[109px] h-[109px] rounded-lg  "/>
                <div className=" flex flex-col mt-2 gap-2 ">
                  <h6 className="text-xs font-bold text-[#223263] w-[109px] h-[36px] ">FS - Nike Air Max 270 React...</h6>
                  <p className="text-xs font-bold text-[#40BFFF] w-[52px] h-[22px] ">$299,43</p>
                  <div className="flex item-center">
        ...
        <div className="mt-6">
          ...
          <div className="flex item-center gap-4 mt-3">
            <div className="h-[238px] w-[141px] border border-[#EBF0FF] rounded-lg p-4 ">
                <img src="https://bom.so/TPboxV" alt="Mo ta" className="w-[109px] h-[109px] rounded-lg  "/>
                <div className=" flex flex-col mt-2 gap-2 ">
              ...
              <div className="h-[238px] w-[141px] border border-[#EBF0FF] rounded-lg p-4 ">
                <img src="https://bom.so/RFh3WK" alt="Mo ta" className="w-[109px] h-[109px] rounded-lg  "/>
                <div className=" flex flex-col mt-2 gap-2 ">
                  <h6 className="text-xs font-bold text-[#223263] w-[109px] h-[36px] ">MS - Nike Air Max 270 React...</h6>
                  <p className="text-xs font-bold text-[#40BFFF] w-[52px] h-[22px] ">$299,43</p>
                  <div className="flex item-center">
        ...
        <div className="relative mt-[9px]">
            <img src="https://bom.so/UqsfLC" alt="Giay"
             className="h-[206px] w-full object-cover object-top brightness-50 rounded-lg"/>
             <div className="absolute top-12 left-6 ">
             <h2 className="text-2xl font-bold text-[#FFF] ">Recomended<br/>Product</h2>
             <p className=" font-normal text-xs text-[#FFF] mt-4">We recommend the best for you</p>
             </div>
        </div>
        ...
        <div className="mt-4 ">
          <div className="flex item-center justify-between">
            <div className="h-[282px] w-[165px] border border-[#EBF0FF] rounded-lg p-4 ">
                  <img src="https://bom.so/UbKd28" alt="Mo ta" className="w-[133px] h-[133px] rounded-lg  "/>
                  <div className=" flex flex-col mt-2 ">
                    <h6 className="text-xs font-bold text-[#223263] w-[133px] h-[36px] ">Nike Air Max 270 React ENG</h6>
                    <div className="flex item-center w-[68px] h-[12px] mt-1 icon-frame " style={{color: '#FFC833' }}>
                      <StarFilled /> <StarFilled /> <StarFilled /> <StarFilled /> 
                      <StarFilled  style={{color: '#EBF0FF' }}/> 
                    </div>
                    <p className="text-xs font-bold text-[#40BFFF] w-[52px] h-[22px] mt-4 ">$299,43</p>
            ...
            <div className="h-[282px] w-[165px] border border-[#EBF0FF] rounded-lg p-4 ">
                  <img src="https://bom.so/TPboxV" alt="Mo ta" className="w-[133px] h-[133px] rounded-lg  "/>
                  <div className=" flex flex-col mt-2 ">
                    <h6 className="text-xs font-bold text-[#223263] w-[133px] h-[36px] ">Nike Air Max 270 React ENG</h6>
                    <div className="flex item-center w-[68px] h-[12px] mt-1 icon-frame " style={{color: '#FFC833' }}>
                      <StarFilled /> <StarFilled /> <StarFilled /> <StarFilled /> 
          ...
          <div className="flex item-center justify-between mt-3">
            <div className="h-[282px] w-[165px] border border-[#EBF0FF] rounded-lg p-4 ">
                  <img src="https://bom.so/m5qo9F" alt="Mo ta" className="w-[133px] h-[133px] rounded-lg  "/>
                  <div className=" flex flex-col mt-2 ">
                    <h6 className="text-xs font-bold text-[#223263] w-[133px] h-[36px] ">Nike Air Max 270 React ENG</h6>
                    <div className="flex item-center w-[68px] h-[12px] mt-1 icon-frame " style={{color: '#FFC833' }}>
                      <StarFilled /> <StarFilled /> <StarFilled /> <StarFilled /> 
            ...
            <div className="h-[282px] w-[165px] border border-[#EBF0FF] rounded-lg p-4 ">
                  <img src="https://bom.so/m1P6z0" alt="Mo ta" className="w-[133px] h-[133px] rounded-lg  "/>
                  <div className=" flex flex-col mt-2 ">
                    <h6 className="text-xs font-bold text-[#223263] w-[133px] h-[36px] ">Nike Air Max 270 React ENG</h6>
                    <div className="flex item-center w-[68px] h-[12px] mt-1 icon-frame " style={{color: '#FFC833' }}>
                      <StarFilled /> <StarFilled /> <StarFilled /> <StarFilled /> 
